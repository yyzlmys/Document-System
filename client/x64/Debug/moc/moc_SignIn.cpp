...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSignInENDCLASS_t qt_meta_stringdata_CLASSSignInENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 5),  // "isLog"
        QT_MOC_LITERAL(13, 0),  // ""
        QT_MOC_LITERAL(14, 1),  // "b"
        QT_MOC_LITERAL(16, 8),  // "sendData"
        QT_MOC_LITERAL(25, 11),  // "messageType"
...
void SignIn::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->isLog((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        ...
        {
            using _t = void (SignIn::*)(bool );
            if (_t _q_method = &SignIn::isLog; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
