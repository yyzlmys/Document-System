...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMainWindow1ENDCLASS_t qt_meta_stringdata_CLASSMainWindow1ENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(47, 9),  // "delete_me"
        QT_MOC_LITERAL(57, 12),  // "MainWindow1*"
        QT_MOC_LITERAL(70, 3)   // "mw1"
    },
    "MainWindow1",
    "timetosend",
    "",
...
void MainWindow1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->delete_me((*reinterpret_cast< std::add_pointer_t<MainWindow1*>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (MainWindow1::*)(int , const QByteArray & );
            if (_t _q_method = &MainWindow1::timetosend; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &MainWindow1::start; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MainWindow1::*)(MainWindow1 * );
            if (_t _q_method = &MainWindow1::delete_me; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void MainWindow1::timetosend(int _t1, const QByteArray & _t2)
{
...
// SIGNAL 1
void MainWindow1::start()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void MainWindow1::delete_me(MainWindow1 * _t1)
{
