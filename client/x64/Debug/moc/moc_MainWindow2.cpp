...
void MainWindow2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MainWindow2::*)(int , const QByteArray & );
            if (_t _q_method = &MainWindow2::timetosend; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MainWindow2::timetosend(int _t1, const QByteArray & _t2)
{
